...
public class DebugConsoleModuleTests
{
    ...
    public void Module_RegistersBuiltInCommandHandlers()
    {
        ...
        // 4 built-in + 11 debug commands + 11 bus-aware commands + 2 device commands = 28 total
    ...
    public void Module_RegistersDebugReplWithHandlers()
    {
        ...
        Assert.Multiple(() =>
        {
            ...
            // 4 built-in + 11 debug commands + 11 bus-aware commands + 2 device commands = 28 total
            Assert.That(dispatcher.Commands, Has.Count.EqualTo(28));
        });
    }
    ...
    public void Module_AllowsAdditionalCommandHandlerRegistration()
    {
        ...
        // 4 built-in + 11 debug + 11 bus-aware + 2 device + 1 custom = 29 total
