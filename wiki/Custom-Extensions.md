...
See [Contributing Guide](https://github.com/jpactor/back-pocket-basic/blob/main/CONTRIBUTING.md) for detailed steps.
...
2. **Open an Issue**: Use the [Feature Request template](https://github.com/jpactor/back-pocket-basic/issues/new?template=feature_request.md)
...
For more information on contributing extensions, see the [Contributing Guide](https://github.com/jpactor/back-pocket-basic/blob/main/CONTRIBUTING.md).
